...
<body>
				...
				<div class="portlet box grey">
					...
					<div class="portlet-title">
						...
						<div class="caption">
							...
							<span class="hidden-480">编辑字典类型</span>
	...
	$(function(){
		$.ajax({
			url : "${path}/sys/admin/dictionary/type/get/${id}",
			type : "get",
			dataType : "json",
			headers: {
		...
		$("#submitbut").on("click",function(){
			...
			if(bool){
				$.ajax({
					url : "${path}/sys/admin/dictionary/type/update",
					type : "post",
					...
					success : function(json){
						if(json.success){
							...
							setTimeout("window.location.href='${path}/sys/admin/dictionary/type/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}'",1300);
						}else{
							document.getElementById("addForm").reset();
							$(".control-group").removeClass("error").removeClass("success");
							$(".help-inline").remove();
