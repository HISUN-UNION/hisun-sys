            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        ...
                        <span class="hidden-480">添加短信配置</span>
                    ...
                    <form action="" class="form-horizontal" id="addForm" method="post">
                        ...
                        <div id="smsNameGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="smsName" name="smsName" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div class="control-group" id="smsServerGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="smsServer" name="smsServer" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div class="control-group" id="apikeyGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="apikey" name="apikey" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div class="control-group" id="versionGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="version" name="version" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div class="control-group" id="sendGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="send" name="send" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div class="control-group" id="tplSendGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="tplSend" name="tplSend" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div class="control-group" id="getTplGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="getTpl" name="getTpl" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div class="control-group" id="addTplGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="addTpl" name="addTpl" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div class="control-group" id="updateTplGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="updateTpl" name="updateTpl" class="span6 m-wrap" required maxlength="255">
                        ...
                        <div id="delTplGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input class="span6 m-wrap" type="text" id="delTpl" name="delTpl"  maxlength="255">
            ...
            if (bool) {
                $.ajax({
                    ...
                    success : function(data){
                        if (data.success) {
                            showSaveSuccess();
                            setTimeout("window.location.href=sys;",130sys                    }
                    }
                });
            }
        });
