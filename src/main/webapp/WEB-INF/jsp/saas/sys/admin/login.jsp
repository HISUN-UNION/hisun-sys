					...
					<div class="control-group">
						...
						<div class="controls login_controls" id="usernameGroup">
							...
							<div class="input-icon left login_mod_inp">
								...
								<input class="m-wrap placeholder-no-fix" type="text" style="padding-left:44px !important;" placeholder="用户名" name="username" id="username" value='<c:out value="${param.username }"></c:out>' required/>
					...
					<div class="control-group">
						...
						<div class="controls login_controls" id="passwordGroup">
							...
							<div class="input-icon left login_mod_inp">
								...
								<input class="m-wrap placeholder-no-fix" style="padding-left:44px !important;" type="password" placeholder="密码" name="password" id="password" required/>
