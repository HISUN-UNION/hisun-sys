	...
	<div class="container-fluid">
			...
			<div class="span12">
				...
				<div class="portlet box grey">
					...
					<div class="portlet-body form">
						<form action="<%=path%>/sys/admin/user/saveByAdd" class="form-horizontal myform"
							...
							<div class="tab-pane active" id="tab1">
								<div>
									...
									<div class="form-actions">
										...
										<a href="${path}/sys/admin/user/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" class="btn btn-default"
		...
		$(function(){
			...
			$("#username").on("blur",function(){
				$.get("<%=path%>/sys/user/checkUserName", { name: $(this).val() },
						  function(data){
						    alert(data);
						  });
			}); --%>
