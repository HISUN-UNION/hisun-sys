            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        ...
                        <span class="hidden-480">更新邮件配置</span>
                    ...
                    <form action="#" class="form-horizontal" id="addForm" method="post">
                        ...
                        <div id="nameGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="name" name="name" class="span6 m-wrap" required maxlength="255" value="${cloud:htmlEscape(config.name)}">
                        ...
                        <div class="control-group" id="accountGroup">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" id="account" name="account" class="span6 m-wrap" required maxlength="255" value="${cloud:htmlEscape(config.account)}">
                        ...
                        <div id="passwordGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input class="span6 m-wrap" type="password" id="password" required name="password"  maxlength="255" value="${cloud:htmlEscape(config.password)}">
                        ...
                        <div id="emailGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input class="span6 m-wrap" type="text" id="email" name="email" maxlength="255" required maxlength="255" value="${cloud:htmlEscape(config.email)}">
                        ...
                        <div id="emailServerGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="emailServer"  required name="emailServer" value="${cloud:htmlEscape(config.emailServer)}" >
                        ...
                        <div id="mailServerGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="mailServer" name="mailServer" value="${cloud:htmlEscape(config.mailServer)}">
                        ...
                        <div id="versionGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="version"   name="version" value="${cloud:htmlEscape(config.version)}" >
                        ...
                        <div id="apiUserGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="apiUser"  name="apiUser" value="${cloud:htmlEscape(config.apiUser)}">
                        ...
                        <div id="apiKeyGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="apiKey" name="apiKey" value="${cloud:htmlEscape(config.apiKey)}" >
                        ...
                        <div id="sendGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="send"  name="send" value="${cloud:htmlEscape(config.send)}">
                        ...
                        <div id="sendTemplateGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="sendTemplate"  name="sendTemplate" value="${cloud:htmlEscape(config.sendTemplate)}">
                        ...
                        <div id="addTemplateGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="addTemplate" name="addTemplate" value="${cloud:htmlEscape(config.addTemplate)}">
                        ...
                        <div id="deleteTemplateGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="deleteTemplate" name="deleteTemplate" value="${cloud:htmlEscape(config.deleteTemplate)}">
                        ...
                        <div id="updateTemplateGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="updateTemplate" name="updateTemplate" value="${cloud:htmlEscape(config.updateTemplate)}">
                        ...
                        <div id="getTemplateGroup" class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span6 m-wrap popovers" id="getTemplate"  required name="getTemplate" value="${cloud:htmlEscape(config.getTemplate)}">
                            ...
                            <div class="controls">
                                ...
                                <select class="span6 m-wrap" id="type" name="type" data-placeholder="Choose a type" tabindex="1" required>
                                    ...
                                    <c:if test="${config.type}">
                                        <option value="1" selected="selected">批量</option>
                                        <option value="0">触发</option>
                                    </c:if>
                                    <c:if test="${!config.type}">
                                        <option value="1">批量</option>
                                        <option value="0" selected="selected">触发</option>
                                    </c:if>
                                </select>
