					...
					<div class="clearfix">
						<div class="control-group">
							<div id="query" style="float: left;margin-left: 10px;width: 100%;">
								<form action="${path}/sys/admin/log/search" id="getLogForm" style="margin: 0 0 10px;" method="get" class="form-horizontal">
									...
									<div class="row-fluid">
		                                    <div class="row-fluid">
		                                        ...
		                                        <div class="input-append" id="starttimeDiv">
													<input type="text" class="span12" value='<c:out value="${param.starttime }"></c:out>' name="starttime" id="starttime" readonly/>
												</div>
		                                        <span class="inp_name">结束日期：</span>
		                                        <div class="input-append" id="endtimeDiv">
													<input type="text" class="span12" value='<c:out value="${param.endtime }"></c:out>' name="endtime" id="endtime" readonly/>
												</div>
		                                        
		                                        <span class="inp_name">用户：</span>
		                                        <input type="text" size="16" class="m-wrap" name="userName" id="userName" style="margin:0px;" placeholder="输入用户名进行搜索" value="${cloud:htmlEscape(param.userName)}" >
		                                    	...
		                                    	<button id="submitBtn" type="button" class="btn green Short_but">清空</button>
		                                 </div>
		                            </div>
								</form>
							</div>
