							...
							<div class="tab-pane active" id="tab1">
								<div>
									<div id="roleNameGroup" class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="roleName" id="name" required maxlength="64">
										</div>
									...
									<div id="roleCodeGroup" class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="roleCode" id="roleCode" required rolePattern="true">
										</div>
									</div>
									<div id="sortGroup" class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="sort" id="sort" required min="1" max="99" value="99">
										</div>
									</div>
									<div id="descriptionGroup" class="control-group">
										...
										<div class="controls">
											<textarea class="span6 m-wrap" style="resize: none;"  rows="5" id="description" name="description" maxlength="255"></textarea>
										</div>
									</div>
