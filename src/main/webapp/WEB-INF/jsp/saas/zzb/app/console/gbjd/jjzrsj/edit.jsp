						...
						<div class="portlet box grey">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">修改经济责任审计</span>
							...
							<div class="portlet-body form">
								...
								<form action="${path }/zzb/app/console/bwh/save" class="form-horizontal" id="form1" method="post" enctype="multipart/form-data">
									...
									<div id="pcsjValueGroup" class="control-group">
										<label class="control-label">委托时间<span class="required">*</span></label>
										<div class="controls">
									...
									<div id="pxGroup" class="control-group">
										<label class="control-label">审计完成时间<span class="required">*</span></label>
										<div class="controls">
									...
									<div class="control-group" id="mbGroup">
										...
										<label class="control-label">审计结果<span class="required">*</span></label>
										<div class="controls">
											<select class="span6 m-wrap" id="mb" name="mb"   data-placeholder="Choose a Category" tabindex="1" required>
									...
									<div  id="clFileGroup" class="control-group" >
										<label class="control-label">审计结果报告</label>
										<div class="controls">
									...
									<div class="control-group">
										<div class="controls mt10">
											...
											<a class="btn" href="${path }/zzb/app/console/gbjd/jjzrsj/sjgbList"><i class="icon-remove-sign"></i> 取消</a>
										</div>
									</div>
								</form>
							</div>
