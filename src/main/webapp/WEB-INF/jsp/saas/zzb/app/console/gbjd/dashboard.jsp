...
<head>
    ...
    <style type="text/css">
        ...
        .ulCadreSuperlist li{ width:13%; float:left; text-align:center; font-size:16px;}
        ...
        .ulCadreSuperlist li.maxico{ width:22%; float:left; font-size:24px; font-weight:bold; }
        .ulCadreSuperlist li.maxico img{ width:153px; height:153px; margin-top:0;}
...
<body>
        ...
        <div class="CadreSuper">
            ...
            <ul class="ulCadreSuperlist">
                <li>
                    <a href="${path}/zzb/app/console/gbjd/grsxch/zdch">
                        <img src="${path}/images/templateImage/Gico01.png">
                        <p>个人事项查核</p>
                    </a>
                </li>
                <li>
                    <a href="${path}/zzb/app/console/gbjd/jjzrsj">
                        <img src="${path}/images/templateImage/Gico02.png">
                        <p>经济责任审计</p>
                    </a>
                </li>
                <li>
                    <a href="${path}/zzb/app/console/gbjd/xfjb">
                        <img src="${path}/images/templateImage/Gico03.png">
                        <p>信访举报</p>
                    </a>
                </li>
                <li class="maxico">
                    <a href="${path}/zzb/app/console/gbjd/base">
                        <img src="${path}/images/templateImage/Gico04.png">
                        <p>干部监督档案</p>
                    </a>
                </li>
                <li>
                    <a href="${path}/zzb/app/console/gbjd/ybglpy">
                        <img src="${path}/images/templateImage/Gico05.png">
                        <p>一报告两评议</p>
                    </a>
                </li>
                <li>
                    <a href="${path}/zzb/app/console/gbjd/zrzj">
                        <img src="${path}/images/templateImage/Gico06.png">
                        <p>责任追究</p>
                    </a>
                </li>
                <li>
                    <a href="${path}/zzb/app/console/gbjd/wz/dzzwz">
                        <img src="${path}/images/templateImage/Gico07.png">
                        <p>问责</p>
                    </a>
                </li>
            </ul>
