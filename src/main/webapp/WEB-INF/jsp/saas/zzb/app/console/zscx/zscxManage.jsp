...
//				beforeDrop: beforeDrop,
		...
		$.ajax({
			async:false,
			type:"POST",
			url:"${path}/zzb/app/console/appZscxB01/ajax/load/tree",
			dataType : "json",
			headers:{
...
//		}
		var _id = node.id;
		$.ajax({
			url : "${path}/zzb/app/console/appZscxB01/ajax/addOrEdit",
			type : "post",
...
//		}
	...
	var deleteTreeNode = function(){
		...
		actionByConfirm1(itemName, "${path}/zzb/app/console/appZscxB01/delete/" + id,{} ,function(data,status){
