...
<div class="xwbmain">
    ...
    <div class="mainone">
        ...
        <div class="mainoneleft">
            <img class="imgtp" width="180" height="200" src="${path}/zzb/app/console/asetA01/51426/photo?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" />
        </div>
        ...
        <div class="mainoneright" style="width: 560px;">
            <div class="Fullname">王照训</div>
            <div class="gerenintrodu">1970.02生，湖南保靖人，1994.07参加工作， 1999.11加入中国共产党 。</div>
            <ul class="ulonleftjx">
                <li><span>全日制学历学位及专业：</span>大专 邵阳师范专科学校政治专业</li>
                <li><span>&nbsp;&nbsp;&nbsp;在职学历学位及专业：</span></span>中央党校函授本科 中央党校函授学院法律专业</li>
            </ul>
        </div>
    </div>
    <div class="maintwo">
