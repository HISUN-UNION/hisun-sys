								...
								<div id="ciNameGroup" class="control-group">
									...
									<div class="controls">
										<select class="span4 m-wrap" type="text" id="influenceInfoId" name="influenceInfoId" required>
											...
											<option value="">副局</option>
										</select>
										<input type="text" class="span4 m-wrap" name="ciName" required maxlength="128" id="ciName" value="" />
									</div>
								</div>
							</td>
							<td width="50%">
