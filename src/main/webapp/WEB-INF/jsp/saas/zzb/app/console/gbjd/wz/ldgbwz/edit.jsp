						...
						<div class="portlet box grey">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">修改问责信息</span>
							...
							<div class="portlet-body form">
								...
								<form action="${path }/zzb/app/console/bwh/save" class="form-horizontal" id="form1" method="post" enctype="multipart/form-data">
									...
									<div class="control-group" id="mbGroup">
										...
										<div class="controls">
											<input type="checkbox"/>通报<input type="checkbox"/>诫勉<input type="checkbox"/>组织调整（组织处理）<input type="checkbox"/>纪律处分
									...
									<div class="control-group">
										<div class="controls mt10">
											...
											<a class="btn" href="${path }/zzb/app/console/gbjd/wz/ldgbwz"><i class="icon-remove-sign"></i> 取消</a>
										</div>
									</div>
								</form>
							</div>
