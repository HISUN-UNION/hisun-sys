		...
		<div class="span12 responsive">
			...
			<form class=""id="importForm" enctype="multipart/form-data">
				...
				<div class="portlet-title">
					<div class="caption">待审核档案：共<font color="red"> 10 </font>人</div>
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover dataTable table-set">
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className=''">
							...
							<TD style="CURSOR: hand; TEXT-ALIGN: center" ><a href="${path}/zzb/app/console/a38/shBase?loadType=shList">戚媚</a> </TD>
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className=''">
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="CURSOR: hand; TEXT-ALIGN: center"><a href="${path}/zzb/app/console/a38/manage">宣庆华</a> </TD>
							<TD style="TEXT-ALIGN: center" width=40>男 </TD>
							<TD>1954.01.25 </TD>
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className='table_tr_dark'" class=table_tr_dark>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="CURSOR: hand; TEXT-ALIGN: center"><a href="${path}/zzb/app/console/a38/manage">药占彤</a> </TD>
							<TD style="TEXT-ALIGN: center" width=40>男 </TD>
							<TD>1964.12 </TD>
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className=''">
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="CURSOR: hand; TEXT-ALIGN: center"><a href="${path}/zzb/app/console/a38/manage">张测试001</a> </TD>
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className='table_tr_dark'" class=table_tr_dark>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="CURSOR: hand; TEXT-ALIGN: center"><a href="${path}/zzb/app/console/a38/manage">刘戒</a> </TD>
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className=''">
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="CURSOR: hand; TEXT-ALIGN: center"><a href="${path}/zzb/app/console/a38/manage">李成</a> </TD>
							<TD style="TEXT-ALIGN: center" width=40></TD>
							<TD></TD>
							<TD title=""></TD>
							<TD>2015.03.12 </TD>
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className='table_tr_dark'" class=table_tr_dark>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="CURSOR: hand; TEXT-ALIGN: center"><a href="${path}/zzb/app/console/a38/manage">胡星</a> </TD>
							<TD style="TEXT-ALIGN: center" width=40>女 </TD>
							<TD>1982.02 </TD>
							<TD title=被培训机构1秘书一处处长>被培训机构1秘书一处处长 </TD>
							<TD>2015.03.12 </TD>
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className=''">
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="CURSOR: hand; TEXT-ALIGN: center"><a href="${path}/zzb/app/console/a38/manage">张烈</a> </TD>
							<TD style="TEXT-ALIGN: center" width=40></TD>
							<TD></TD>
						...
						<TR onmouseover="this.className='table_tr_mouse'" onmouseout="this.className='table_tr_dark'" class=table_tr_dark>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="TEXT-ALIGN: center"></TD>
							<TD style="CURSOR: hand; TEXT-ALIGN: center"><a href="${path}/zzb/app/console/a38/manage">张家华</a> </TD>
							<TD style="TEXT-ALIGN: center" width=40></TD>
							<TD></TD>
							<TD title=""></TD>
							<TD>2015.03.12 </TD>
