		...
		<div class="portlet box grey ">
			...
			<div class="tabbable tabbable-custom">
				<ul class="nav nav-tabs" style="font-size: 14px;font-weight: bold;" id="tabs">
					<li class="active"><a id="#tab_1_1" href="#tab_1_1" data-toggle="tab">正在阅档</a></li>
					<li ><a id="#tab_1_2" href="#tab_1_1" data-toggle="tab">授权阅档</a></li>
					<li ><a id="#tab_1_3" href="#tab_1_1" data-toggle="tab">申请阅档</a></li>
				</ul>
...
//		});
	...
	function zzydLoad(){
		$.ajax({
			url : "${path }/zzb/app/console/a38/ajax/zzydRecodeList",
			type : "post",
			data : {},
			dataType : "html",
	...
	function shouquanydLoad(){
		$.ajax({
			url : "${path }/zzb/app/console/a38/ajax/shouquanydRecodeList",
			type : "post",
	...
	function sqydLoad(){
		$.ajax({
			url : "${path }/zzb/app/console/a38/ajax/sqydRecodeList",
			type : "post",
			data : {"parentId":"${parentId}","id":"${ciId}"},
			dataType : "html",
			success : function(html){
