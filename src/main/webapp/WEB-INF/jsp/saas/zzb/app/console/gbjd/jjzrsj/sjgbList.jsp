		...
		<div class="span12 responsive">
			...
			<form class=""id="importForm" enctype="multipart/form-data">
				...
				<div class="portlet-title">
					<div class="caption">2017年经济责任审计</div>
					...
					<div class="control-group">
						<div id="query" style="float: left;">
							<form action="${path }/zzb/app/console/asetA01/ajax/list" method="POST" id="searchForm" name="searchForm">
								...
								单位：<input type="text" class="m-wrap" name="xmQuery" id="xmQuery" value="${xmQuery}" style="width: 100px;" />
								审计结果：
								<select class="select_form" tabindex="-1" name="type" id="type" style="width: 100px; margin-bottom: 0px;" >
									<option value="">全部</option>
									<option value="">合规</option>
									<option value="">不合规</option>
								</select>
								委托时间：<input type="text" class="m-wrap" name="xmQuery" id="xmQuery" value="${xmQuery}" style="width: 100px;" />
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover dataTable table-set">
						...
						<tr>
							...
							<th width="150">审计完成时间</th>
							<th width="150">审计结果</th>
							<th width="100">审计结果报告</th>
							<th width="90">操作</th>
						</tr>
						</thead>
						<tbody>
							<tr style="text-overflow:ellipsis;">
								<td ><a href="${path}/zzb/app/console/gbjd/jjzrsj/edit" class="">刘洋</a></td>
