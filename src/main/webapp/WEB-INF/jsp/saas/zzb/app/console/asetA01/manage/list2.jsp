...
<div class="container-fluid">
	...
	<div id="jsonDataModal" class="modal container hide fade" tabindex="-1" data-width="500">
			...
			<form class=""id="importForm" enctype="multipart/form-data">
				...
				<div class="portlet-title">
					...
					<div class="clearfix fr">
						...
						<a id="sample_editable_1_new" class="btn green" href="javascript:importGb()">
							<i class="icon-circle-arrow-up"></i>导入干部数据
						</a>
...
<script type="text/javascript">
	...
	var importGb = function(){
		$.ajax({
			url : "${path}/zzb/app/console/asetA01/ajax/drGbList",
			type : "post",
			data: {},
			headers:{
