			...
			<form class=""id="importForm" enctype="multipart/form-data">
					...
					<div class="control-group">
						<div id="query" style="float: left;">
							<form action="${path }/zzb/app/console/asetA01/ajax/list" method="POST" id="searchForm" name="searchForm">
								...
								被追究人：<input type="text" class="m-wrap" name="xmQuery" id="xmQuery" value="${xmQuery}" style="width: 100px;" />
								...
								追究时间：<input type="text" class="m-wrap" name="xmQuery" id="xmQuery" value="${xmQuery}" style="width: 100px;" />
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover dataTable table-set">
						<thead>
						<tr>
							<th width="90">被追究人姓名</th>
							<th >单位职务</th>
							<th width="150">职级</th>
							<th width="150">责任追究方式</th>
							<th width="150">追究时间</th>
							<th width="150">处理状态</th>
							<th width="100">责任处分书</th>
							<th width="90">操作</th>
						</tr>
						</thead>
						<tbody>
							<tr style="text-overflow:ellipsis;">
								<td ><a href="${path}/zzb/app/console/gbjd/zrzj/edit" class="">刘洋</a></td>
