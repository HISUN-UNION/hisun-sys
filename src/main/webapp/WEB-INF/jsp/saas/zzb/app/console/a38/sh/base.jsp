...
<div >
	...
	<div class="portlet-title">
		...
		<div class="portlet-title" style="text-align: right">
				...
				<button type="button" class="btn green" onclick="formSubmit()"><i class="icon-ok"></i> 审核通过</button>
				<button type="button" class="btn green" onclick="formSubmit()"><i class="icon-remove"></i> 审核不通过</button>
...
<script type="text/javascript">
	...
	function cancel(){
			window.location.href = "${path}/zzb/app/console/a38/shList";
