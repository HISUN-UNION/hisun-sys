				...
				<ul class="nav pull-right" style="margin:0;">
					...
					<shiro:hasPermission name="adminticekt:ticketservice ">
						<li class="dropdown lired" id="header_notification_bar">
							...
							<ul class="dropdown-menu extended notification" style="width: 120px !important;min-width: 120px !important;">
								<shiro:hasPermission name="adminticket:ticket_createIndex">
									<li>
										<a style="width: 100px;" href="${path}/sys/admin/ticket/createIndex?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}">
											<i class="icon-pencil"></i> 提交工单
										</a>
									</li>
									<li>
										<a style="width: 100px;" href="${path}/sys/admin/ticket/mine?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}">
											<i class="icon-folder-open"></i> 我的工单</a>
									</li>
								</shiro:hasPermission>
								<shiro:hasPermission name="adminticket:ticket_customadmin">
									<li>
										<a style="width: 100px;" href="${path}/sys/admin/ticket/custom/admin/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}">
