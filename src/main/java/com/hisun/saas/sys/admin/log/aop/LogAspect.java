...
/**
 * 
 * <p>Title: TenantLogAspect</p>
 * <p>Description: aop日志处理</p>
 * <p>Copyright: Copyright (c) 2015</p>
 * <p>Company: 湖南海数互联信息技术有限公司</p>
 * @author Jason
 * @email jason4j@qq.com
 * @date 2015年5月21日 下午5:28:56 
 * @version
 */
@Aspect
@Component
public class LogAspect {
	 ...
	 * 添加业务逻辑方法切入点
	 */
	@Pointcut("execution(* com.hisun.cloud.sys..*.service..*Impl.save*(..)) || execution(* com.hisun.cloud.sys..*.service..*Impl.add*(..))")
	 ...
	 * 修改业务逻辑方法切入点
	 */
	@Pointcut("execution(* com.hisun.cloud.sys..*.service..*Impl.update*(..)) || execution(* com.hisun.cloud.sys..*.service..*Impl.edit*(..))")
	 ...
	 * 删除影片业务逻辑方法切入点
	 */
	@Pointcut("execution(* com.hisun.cloud.sys..*.service..*Impl.delete*(..)) || execution(* com.hisun.cloud.sys..*.service..*Impl.remove*(..))")
	...
	private void saveLog(Throwable e) {
		...
		if(StringUtils.isBlank(ip)){
		 ...
		 try {
			...
			if(Constants.TYPE_TENANT == userLoginDetails.getType()){
