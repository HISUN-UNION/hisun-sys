...
public class CasRealm extends org.apache.shiro.cas.CasRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {  
		...
		if (role != null) {
			...
			if (org.apache.commons.lang3.StringUtils.equals("0", role.getProperty())) {
				roleCode = Constants.ROLE_CARRIERS;
			} else if (org.apache.commons.lang3.StringUtils.equals("1", role.getProperty())) {
				roleCode = Constants.ROLE_SERVICE_PROVIDERS;
			} else if (org.apache.commons.lang3.StringUtils.equals("2", role.getProperty())) {
