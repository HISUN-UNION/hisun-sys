...
import com.hisun.saas.zzb.app.console.gbcx.dao.AppGbcxB01Dao;
 ...
 */
@Service
public class AppGbcxB01ServiceImpl extends BaseServiceImpl<AppGbcxB01,String> implements AppGbcxB01Service {

    private AppGbcxB01Dao appGbcxB01Dao;

    @Autowired
    public void setBaseDao(BaseDao<AppGbcxB01, String> appGbcxB01Dao) {
        this.baseDao = appGbcxB01Dao;
        this.appGbcxB01Dao = (AppGbcxB01Dao) appGbcxB01Dao;
    }
    public Integer getMaxPx(String parentId){
        ...
        List<Map> maxSorts = this.appGbcxB01Dao.countReturnMapBySql(hql, arg);
    ...
    public void updatePx(String parentId,int oldPx,int newPx){
        ...
        this.appGbcxB01Dao.update(sql, paramMap);
    }
}
