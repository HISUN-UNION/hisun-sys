 ...
 */
public class AppAsetA01QueryVo {
    ...
    private String xm;
    private String xb;
    private String nlStart;
    private String nlEnd;
    private String mz;
    private String zw;
    private String csd;
    private String jg;
    ...
    public String getNlStart() {
        return nlStart;
    }

    public void setNlStart(String nlStart) {
        this.nlStart = nlStart;
    }

    public String getNlEnd() {
        return nlEnd;
    }

    public void setNlEnd(String nlEnd) {
        this.nlEnd = nlEnd;
    }
