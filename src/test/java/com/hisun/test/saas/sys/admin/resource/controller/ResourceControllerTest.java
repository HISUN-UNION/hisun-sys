...
/**
 * <p>Title: ResourceControllerTest.java </p>
 * <p>Package com.hisun.saas.sys.resource.controller </p>
 * <p>Description: TODO</p>
 * <p>Copyright: Copyright (c) 2015</p>
 * <p>Company: 湖南海数互联信息技术有限公司</p>
 * @author Jason
 * @email jason4j@qq.com
 * @date 2015年9月14日 下午3:58:30 
 * @version 
 */
...
public class ResourceControllerTest {
	...
	public void testTreeResources() throws Exception {
        ...
        //测试普通控制器
        mockMvc.perform(get("/platform/admin/resource/list/tree")) //执行请求
                //.andExpect(model().attributeExists("user")) //验证存储模型数据
                .andExpect(view().name("/cloud/platform/admin/resource/listTreeResource")) //验证viewName
                .andExpect(forwardedUrl("/cloud/platform/admin/resource/listTreeResource"))//验证视图渲染时forward到的jsp
	...
	public void testQueryCodeLink() throws Exception {
		...
		userLoginDetails.setResources(Collections.<com.hisun.saas.sys.admin.resource.entity.Resource>emptyList());
		ShiroTestHelper.mockSubject("test",userLoginDetails);
		MvcResult result = mockMvc.perform(post("/platform/admin/resource/link").param("menuCode", "001"))//执行请求
				.andDo(print())
